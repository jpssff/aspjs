 ...
 * This appends items to a collection in such a way that if an item with that key exists,
 * it will use an array to hold the existing and new item(s).
 *
 * @param {Object} obj Collection of key/value pairs
 * @param {String} key Property name
 * @param {String} val Item to be appended
 */
function appendItem(obj, key, val) {
  ...
  if (cb) {
    ...
    this
      .on('field', function(name, value) {
        appendItem(fields, name, value);
        //fields[name] = value;
      })
      .on('file', function(name, file) {
        appendItem(files, name, file);
        //files[name] = file;
      })
      .on('error', function(err) {
        cb(err, fields, files);
