 ...
 * var product = new Collection({name:'apple',type:'fruit'});
 * product('name','banana'); //shorthand for product.set(..)
 * product('Type'); //returns 'fruit' (case-insensitive)
 * product('valueOf',2.27);
 * product.count(); //returns 3
 * product.valueOf(); //returns object
 *   {name:'banana',type:'fruit','valueOf':2.27}
 *
 */
