  ...
  app('/test/session/run', function() {
    ...
    test("JSON", function() {
      ...
      var expected = '{"str":"\\u2039un\\u00efc\\u00f8de\\u203a","num":17,"date":'
        ...
        + '[Infinity,false]]}';
      var stringified = JSON.stringify(obj, false);
      equals(stringified, expected, 'Check JSON.stringify');
      equals(stringified, JSON.stringify(JSON.parse(stringified), false), 'Check JSON.stringify(JSON.parse)');
    });
    ...
    test("Cookies", function() {
      ...
      ok(JSON.stringify(res.cookies(), false), expected, 'Check cookies collection serializes correctly');
      //Remove Test Cookies
